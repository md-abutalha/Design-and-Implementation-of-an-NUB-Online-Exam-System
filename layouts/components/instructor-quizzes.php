<div class="container page__container">
                        ...
                        <div class="media align-items-center mb-headings">
                            ...
                            <div class="media-right d-flex align-items-center">
                                <a href="fixed-instructor-quiz-edit.html"
                        ...
                        <div class="card-columns">
                            ...
                            <div class="card card-sm">
                                <div class="card-body media">
                                    <div class="media-left">
                                        <a href="fixed-instructor-review-quiz.html"
                                ...
                                <div class="card-footer text-center">
                                    <a href="fixed-instructor-review-quiz.html"
                                       class="btn btn-white btn-sm float-left"><i class="material-icons btn__icon--left">playlist_add_check</i> Review <span class="badge badge-dark ml-2">5</span></a>
                                    <a href="fixed-instructor-quiz-edit.html"
                            ...
                            <div class="card card-sm">
                                <div class="card-body media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="card-title mb-0"><a href="fixed-instructor-review-quiz.html">GitHub Basic Setup</a></h4>
                            ...
                            <div class="card card-sm">
                                <div class="card-body media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="card-title mb-0"><a href="fixed-instructor-review-quiz.html">Gulp Front-End Boilerplate</a></h4>
